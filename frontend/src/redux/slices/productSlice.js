...
const productSlice = createSlice({
    ...
    initialState: {
        products: [],
        productDetails: null, // Store the details of the single product
        similarProducts: [],
        loading: false,
        error: null,
        filters: {
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(fetchProductDetails.fulfilled, (state, action) => {
                state.loading = false;
                state.productDetails = action.payload; // Store fetched product details
            })
            .addCase(fetchProductDetails.rejected, (state, action) => {
                state.loading = false;
                state.error = action.error.message; // Set error if request fails
            })
